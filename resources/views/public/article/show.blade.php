                        ...
                        <div class="box">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#"><span class="la la-newspaper"></span> Articles</a> </li>
                                    <li class="breadcrumb-item"><a href="#"><span class="la la-folder-open"></span>{{ $article->categorisation->name }}</a>
                                    </li>
                                </ol>
                            </nav>
                            <article>
                                <figure class="post_body">
                                    <img src="{{ asset('uploads/articles') . '/' . $article->main_image }}" class="img-fluid" alt="Article Image">
                                ...
                                <div class="author_body mb-4">
                                    ...
                                    <div class="media-body">
                                        <h5 class="author_name">{{ $article->writer->name }}</h5>
                                    </div>
                                </div>
